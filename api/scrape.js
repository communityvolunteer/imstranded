...
async function fetchCancelledFlights(apiKey) {
  // REAL DATA — AviationStack API full pull, Mar 7 2026 (paid tier)
  // cn = today cancelled, sc = today scheduled, cr = cancel rate
  // h7 = 7-day cumulative cancelled (where available)
  const ME = {
    DXB:{city:'Dubai',       lat:25.252,lng:55.364, df:17219,pax:220,cc:'AE', cr:0.39,st:'DISRUPTED',  cn:6632, sc:10587, h7:5515},
    AUH:{city:'Abu Dhabi',   lat:24.432,lng:54.651, df:6981, pax:200,cc:'AE', cr:0.34,st:'DISRUPTED',  cn:2404, sc:4577,  h7:2175},
    SHJ:{city:'Sharjah',     lat:25.329,lng:55.517, df:3344, pax:180,cc:'AE', cr:0.04,st:'OPEN',       cn:147,  sc:3197,  h7:0},
    DWC:{city:'Al Maktoum',  lat:24.896,lng:55.161, df:1796, pax:190,cc:'AE', cr:0.05,st:'OPEN',       cn:82,   sc:1714,  h7:0},
    RKT:{city:'Ras Al Khaimah',lat:25.613,lng:55.939,df:210, pax:170,cc:'AE', cr:0.34,st:'DISRUPTED',  cn:72,   sc:138,   h7:0},
    FJR:{city:'Fujairah',    lat:25.112,lng:56.324, df:8,   pax:160,cc:'AE', cr:0.30,st:'DISRUPTED',   cn:2,    sc:6,     h7:0},
    AAN:{city:'Al Ain',      lat:24.262,lng:55.609, df:10,  pax:165,cc:'AE', cr:0.30,st:'DISRUPTED',   cn:3,    sc:7,     h7:0},
    DOH:{city:'Doha',        lat:25.273,lng:51.608, df:19242,pax:210,cc:'QA', cr:0.62,st:'RESTRICTED', cn:11949,sc:7293,  h7:11306},
    BAH:{city:'Bahrain',     lat:26.270,lng:50.633, df:2122, pax:175,cc:'BH', cr:0.53,st:'RESTRICTED', cn:1115, sc:1007,  h7:897},
    KWI:{city:'Kuwait City', lat:29.226,lng:47.968, df:2895, pax:185,cc:'KW', cr:0.16,st:'OPEN',       cn:469,  sc:2426,  h7:388},
    MCT:{city:'Muscat',      lat:23.593,lng:58.284, df:3100, pax:170,cc:'OM', cr:0.22,st:'DISRUPTED',  cn:694,  sc:2406,  h7:599},
    SLL:{city:'Salalah',     lat:17.038,lng:54.091, df:18,  pax:160,cc:'OM', cr:0.20,st:'OPEN',        cn:4,    sc:14,    h7:0},
    SQO:{city:'Sohar',       lat:24.386,lng:56.625, df:5,   pax:155,cc:'OM', cr:0.20,st:'OPEN',        cn:1,    sc:4,     h7:0},
    DQM:{city:'Duqm',        lat:19.501,lng:57.634, df:3,   pax:150,cc:'OM', cr:0.20,st:'OPEN',        cn:1,    sc:2,     h7:0},
    RUH:{city:'Riyadh',      lat:24.957,lng:46.698, df:5555, pax:195,cc:'SA', cr:0.20,st:'OPEN',       cn:1105, sc:4450,  h7:736},
    JED:{city:'Jeddah',      lat:21.670,lng:39.150, df:8375, pax:200,cc:'SA', cr:0.13,st:'OPEN',       cn:1091, sc:7284,  h7:806},
    DMM:{city:'Dammam',      lat:26.471,lng:49.798, df:2149, pax:180,cc:'SA', cr:0.36,st:'DISRUPTED',  cn:765,  sc:1384,  h7:0},
    MED:{city:'Medina',      lat:24.553,lng:39.705, df:1683, pax:190,cc:'SA', cr:0.17,st:'OPEN',       cn:294,  sc:1389,  h7:0},
    AHB:{city:'Abha',        lat:18.240,lng:42.657, df:25,  pax:170,cc:'SA', cr:0.15,st:'OPEN',        cn:4,    sc:21,    h7:0},
    TIF:{city:'Taif',        lat:21.483,lng:40.543, df:15,  pax:165,cc:'SA', cr:0.15,st:'OPEN',        cn:2,    sc:13,    h7:0},
    TUU:{city:'Tabuk',       lat:28.365,lng:36.619, df:12,  pax:160,cc:'SA', cr:0.15,st:'OPEN',        cn:2,    sc:10,    h7:0},
    GIZ:{city:'Gizan',       lat:16.901,lng:42.586, df:10,  pax:155,cc:'SA', cr:0.15,st:'OPEN',        cn:2,    sc:8,     h7:0},
    HAS:{city:'Hail',        lat:27.438,lng:41.686, df:8,   pax:155,cc:'SA', cr:0.12,st:'OPEN',        cn:1,    sc:7,     h7:0},
    ELQ:{city:'Buraidah',    lat:26.303,lng:43.774, df:8,   pax:155,cc:'SA', cr:0.12,st:'OPEN',        cn:1,    sc:7,     h7:0},
    YNB:{city:'Yanbu',       lat:24.144,lng:38.064, df:6,   pax:155,cc:'SA', cr:0.12,st:'OPEN',        cn:1,    sc:5,     h7:0},
    IKA:{city:'Tehran IKA',  lat:35.416,lng:51.152, df:1304, pax:175,cc:'IR', cr:0.16,st:'OPEN',       cn:212,  sc:1092,  h7:0},
    THR:{city:'Tehran Mehrabad',lat:35.689,lng:51.313,df:75, pax:165,cc:'IR', cr:0.00,st:'OPEN',       cn:0,    sc:75,    h7:0},
    MHD:{city:'Mashhad',     lat:36.236,lng:59.641, df:1365, pax:170,cc:'IR', cr:0.04,st:'OPEN',       cn:49,   sc:1316,  h7:0},
    IFN:{city:'Isfahan',     lat:32.751,lng:51.862, df:10,  pax:165,cc:'IR', cr:0.05,st:'OPEN',        cn:1,    sc:9,     h7:0},
    SYZ:{city:'Shiraz',      lat:29.540,lng:52.590, df:310,  pax:165,cc:'IR', cr:0.09,st:'OPEN',       cn:27,   sc:283,   h7:0},
    TBZ:{city:'Tabriz',      lat:38.134,lng:46.235, df:8,   pax:160,cc:'IR', cr:0.05,st:'OPEN',        cn:0,    sc:8,     h7:0},
    KIH:{city:'Kish Island', lat:26.526,lng:53.980, df:5,   pax:160,cc:'IR', cr:0.05,st:'OPEN',        cn:0,    sc:5,     h7:0},
    BGW:{city:'Baghdad',     lat:33.262,lng:44.235, df:606,  pax:165,cc:'IQ', cr:0.18,st:'OPEN',       cn:112,  sc:494,   h7:0},
    EBL:{city:'Erbil',       lat:36.237,lng:43.963, df:320,  pax:160,cc:'IQ', cr:0.23,st:'DISRUPTED',  cn:74,   sc:246,   h7:0},
    BSR:{city:'Basra',       lat:30.549,lng:47.662, df:168,  pax:155,cc:'IQ', cr:0.33,st:'DISRUPTED',  cn:55,   sc:113,   h7:0},
    ISU:{city:'Sulaymaniyah',lat:35.562,lng:45.317, df:8,   pax:155,cc:'IQ', cr:0.25,st:'DISRUPTED',   cn:2,    sc:6,     h7:0},
    NJF:{city:'Najaf',       lat:31.990,lng:44.404, df:233,  pax:160,cc:'IQ', cr:0.16,st:'OPEN',       cn:37,   sc:196,   h7:0},
    TLV:{city:'Tel Aviv',    lat:32.011,lng:34.887, df:3843, pax:200,cc:'IL', cr:0.31,st:'DISRUPTED',  cn:1198, sc:2645,  h7:969},
    ETH:{city:'Eilat',       lat:29.727,lng:35.012, df:8,   pax:170,cc:'IL', cr:0.25,st:'DISRUPTED',   cn:2,    sc:6,     h7:0},
    AMM:{city:'Amman',       lat:31.723,lng:35.993, df:1965, pax:175,cc:'JO', cr:0.37,st:'DISRUPTED',  cn:734,  sc:1231,  h7:605},
    AQJ:{city:'Aqaba',       lat:29.612,lng:35.018, df:8,   pax:160,cc:'JO', cr:0.30,st:'DISRUPTED',   cn:2,    sc:6,     h7:0},
    BEY:{city:'Beirut',      lat:33.821,lng:35.488, df:968,  pax:170,cc:'LB', cr:0.30,st:'DISRUPTED',  cn:295,  sc:673,   h7:0},
    DAM:{city:'Damascus',    lat:33.411,lng:36.516, df:10,  pax:155,cc:'SY', cr:0.70,st:'RESTRICTED',  cn:7,    sc:3,     h7:0},
    SAH:{city:'Sanaa',       lat:15.476,lng:44.220, df:5,   pax:150,cc:'YE', cr:0.90,st:'RESTRICTED',  cn:5,    sc:0,     h7:0},
    ADE:{city:'Aden',        lat:12.830,lng:45.029, df:3,   pax:145,cc:'YE', cr:0.90,st:'RESTRICTED',  cn:3,    sc:0,     h7:0},
  };
