...
.sitrep-label{
  ...
  color:rgb(255, 255, 255);line-height:1.3;
}
.sitrep-sub{font-size:.5rem;color:rgb(255, 255, 255);margin-top:.1rem;}
.sitrep-refresh{
...
.map-community-bar{
  ...
  left:calc(var(--sidebar-w, 280px) + (100% - var(--sidebar-w, 280px) - var(--right-sidebar-w, 0px)) / 2);
...
.country-card{
  ...
  border-top:8px solid var(--border2);border-radius:var(--radius);
...
.embassy-title{font-size:.62rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--muted);margin-bottom:.45rem;}
.embassy-row{display:flex;align-items:center;gap:.6rem;padding:.38rem 0;border-bottom:1px solid var(--border);font-size:.8rem;}
.embassy-row:last-child{border-bottom:none;}
.embassy-name{flex:1;font-weight:500;color:#fff;}
.embassy-note{font-size:.7rem;color:var(--muted);}
...
.p-verify-btn--linked{
  background:rgba(var(--accent-r),var(--accent-g),var(--accent-b),.15);border-color:rgba(var(--accent-r),var(--accent-g),var(--accent-b),.3);
  color:var(--accent);
}
.p-verify-btn--link{
  background:rgba(var(--accent-r),var(--accent-g),var(--accent-b),.1);border-color:rgba(var(--accent-r),var(--accent-g),var(--accent-b),.25);
  color:var(--accent);cursor:pointer;
}
.p-verify-btn--link:hover{background:rgba(var(--accent-r),var(--accent-g),var(--accent-b),.2);}
...
.linked-input-lock{
  ...
  color:rgba(52,152,236,.5);display:none;
}
...
.help-tab-dot--offer{background:#3498ec;}

.post-form-header{
  font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;
  padding:.6rem 1rem;border-radius:var(--radius-sm) var(--radius-sm) 0 0;
}
.post-form-header--offer{color:#fff;background:#3498ec;border-left:3px solid #3498ec;}
.post-form-header--live{color:#fff;background:#3498ec;border-left:3px solid #3498ec;}
...
.submit-btn--offer{background:#3498ec;}
.submit-btn--offer:hover{background:#2980c8;}
.posts-list{display:flex;flex-direction:column;gap:.75rem;}
.post-card{background:var(--surface);border:1px solid var(--border);border-left:3px solid var(--green);border-radius:var(--radius-sm);padding:1rem;}
.post-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:.3rem;}
.post-type{font-size:.6rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--green);}
.post-time{font-size:.63rem;color:var(--muted);}
.post-loc{font-size:.78rem;font-weight:600;color:var(--text2);margin-bottom:.3rem;}
.post-body{font-size:.84rem;color:var(--text2);line-height:1.5;margin-bottom:.6rem;}
...
@media (max-width:600px){
  ...
  .m-tab{
    ...
    padding:.4rem 0;font-family:'Inter',sans-serif;font-size:.5rem;
  ...
  .m-tab-spare{
    ...
    background:rgb(255, 255, 255);border:none;border-top:2px solid rgba(52,152,236,.2);
  ...
  .m-form-label{display:block;font-size:.62rem;font-weight:700;text-transform:uppercase;letter-spacing:.07em;color:#fff;margin-bottom:.32rem;}
  ...
  .m-form-row input::placeholder,.m-form-row textarea::placeholder{color:rgba(255,255,255,.35);}
  .m-form-row input:focus,.m-form-row textarea:focus{border:1.5px solid var(--accent);background:rgba(var(--accent-r),var(--accent-g),var(--accent-b),.06);}
...
/* ═══ Filter Panel ═══ */
.filter-panel{
  position:absolute;top:0;left:0;bottom:0;width:280px;z-index:900;
...
.fp-section--blue .fp-toggle input:checked + .fp-toggle-slider{background:#3498ec;}
...
.fp-chip--blue:has(input:checked){background:rgba(52,152,236,.15);border-color:rgba(52,152,236,.3);color:#3498ec;}
.fp-chip--red:has(input:checked){background:rgba(236,52,82,.15);border-color:rgba(236,52,82,.3);color:#ec3452;}
.fp-chip--amber:has(input:checked){background:rgba(255,159,28,.15);border-color:rgba(255,159,28,.3);color:#ff9f1c;}
.fp-select{
...
/* Sitrep filter stat */
.sitrep-stat--filter{
  flex:0 0 280px !important;min-width:auto !important;cursor:pointer;
  border-right:1px solid rgba(255,255,255,.08);
}
...
.hstep-num.done{background:var(--accent);color:#fff;}
...
.hstep-badge{
  ...
  border-radius:4px;padding:.08rem .32rem;font-size:.63rem;font-weight:700;color:var(--accent);
...
.hstep-btn--blue{background:rgba(var(--accent-r),var(--accent-g),var(--accent-b),.13);color:var(--accent);border:1px solid rgba(var(--accent-r),var(--accent-g),var(--accent-b),.22);}
.hstep-btn--purple{background:rgba(var(--accent-r),var(--accent-g),var(--accent-b),.13);color:var(--accent);border:1px solid rgba(var(--accent-r),var(--accent-g),var(--accent-b),.22);}
.hstep-btn--red{background:rgba(236,52,82,.1);color:#ec3452;border:1px solid rgba(236,52,82,.18);}
...
.m-tab-spare svg { stroke: #3498ec !important; }
...
.manage-action-btn--blue { background: #3498ec; }
